...
public class LoginController {
    ...
    private void handleLogin() {
        ...
        try {
            ...
            Platform.runLater(() -> {
                ...
                // ✅ Redirection : Admin -> Dashboard ; Étudiant/Prestataire -> Rechercher des services
                if (user instanceof Admin) {
                    navigateToAdminDashboard((Admin) user);
                } else {
                    AppSession.setCurrentUser(user);
                    navigateToRechercherServices(user);
                }
            });
    ...
    /** Première page après login (étudiant/prestataire) : Rechercher des services */
    private void navigateToRechercherServices(User user) {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/Views/Student.fxml"));
            Parent root = loader.load();

            Student_controller controller = loader.getController();
            ...
            System.err.println("❌ Erreur navigation vers Rechercher services: " + e.getMessage());
            e.printStackTrace();
    ...
    private void navigateToProfile(User user) {
        try {
            ...
            System.err.println("❌ Erreur navigation ProfileView: " + e.getMessage());
            ...
            try {
                ...
                if (existingUser != null) {
                    ...
                    Platform.runLater(() -> {
                        ...
                        AppSession.setCurrentUser(existingUser);
                        navigateToRechercherServices(existingUser);
                    });
                    ...
                    Platform.runLater(() -> {
                        ...
                        AppSession.setCurrentUser(finalUser);
                        navigateToRechercherServices(finalUser);
                    });
                }
