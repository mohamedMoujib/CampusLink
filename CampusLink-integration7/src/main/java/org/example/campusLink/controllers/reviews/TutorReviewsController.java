...
public class TutorReviewsController {
    ...
    // =========================================================
    // 🔥 STARS (CORRIGÉ - Étoiles négatives en ROUGE)
    // =========================================================
    ...
    private HBox createStarsDisplay(int rating) {
        ...
        if (rating < 0) {
            ...
            // ✅ ÉTOILES POSITIVES - OR
            starsText = "★".repeat(rating) + "☆".repeat(5 - rating);
            color = "#fbbf24"; // Or/Jaune
            badge = "(+" + rating + ")";
        ...
        container.getChildren().addAll(starsLabel, badgeLabel);
        return container;
    }
