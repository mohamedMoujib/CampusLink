...
public class ReservationsController {
    ...
    private void updateStats() {
        try {
            ...
            double revenu  = mine.stream()
                    ...
                    .mapToDouble(r -> r.getPrice() != null
                            ? r.getPrice().doubleValue() : 0)
                    .sum();
    ...
    private void onFilterUpcoming() {
        ...
        try {
            List<Reservation> list =
                    reservationService.getUpcomingReservationsForProvider(
    ...
    // ✅ Navigate to messagerie and open conversation with the student
    private void onContact(Reservation r) {
        ...
        try {
            ...
            // ✅ Open conversation with the STUDENT (not provider)
            ctrl.openConversationWithUser(r.getStudentId());
