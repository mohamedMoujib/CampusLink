...
public class ReviewsDAO {
    ...
    // ===================== 🔥 GET CONFIRMED RESERVATIONS FOR STUDENT =====================
            ...
            try (PreparedStatement ps = conn.prepareStatement(sql)) {
                ...
                try (ResultSet rs = ps.executeQuery()) {
                    while (rs.next()) {
                        ...
                        reservation.put("serviceTitle", rs.getString("service_title"));
                        reservation.put("prestataireName", rs.getString("prestataire_name"));
                        reservation.put("prestataireId", rs.getInt("prestataire_id"));
