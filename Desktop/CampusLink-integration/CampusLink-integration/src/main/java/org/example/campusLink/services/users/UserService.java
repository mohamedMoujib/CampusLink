...
public class UserService implements Iservice<User> {
    ...
    private void modifierAdmin(Admin admin) throws SQLException {
        ...
        try (PreparedStatement ps = conn.prepareStatement(sql)) {
            ...
            ps.setString(4, admin.getPhone());
            ps.setString(5, admin.getGender());
            ps.setString(6, admin.getProfilePicture()); // ✅ was wrongly index 7
            ps.setString(7, admin.getAddress());        // ✅ was wrongly index 8
            ps.setString(8, admin.getStatus());         // ✅ was wrongly index 9
            ps.setInt(9, admin.getId());                // ✅ was wrongly index 10
            ps.executeUpdate();
        }
    }
    // ==================== DELETE ====================
