...
public class Service_controller {
    ...
    private int currentPrestataireId;
    ...
    private void goToCreateService() {
        ...
        try {
            ...
            e.printStackTrace();
            showAlert("Erreur", "Impossible d'ouvrir: " + e.getMessage(), Alert.AlertType.ERROR);
        }
    }
    ...
    public void setCurrentPrestataireId(int currentPrestataireId) {
        this.currentPrestataireId = currentPrestataireId;
    }
}