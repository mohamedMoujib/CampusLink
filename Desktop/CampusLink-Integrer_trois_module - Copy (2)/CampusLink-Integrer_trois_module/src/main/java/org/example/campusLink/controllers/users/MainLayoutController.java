...
public class MainLayoutController {
    ...
    static {
        ...
        ETUDIANT_NAV.put("📅 Réservations",            "/Views/etudiant/ReservationsView.fxml");
        ETUDIANT_NAV.put("💬 Messagerie",              "/Views/etudiant/MessagerieView.fxml");
        ETUDIANT_NAV.put("💳 Paiements",               "/Views/etudiant/PaiementsView.fxml");
        ...
        PRESTATAIRE_NAV.put("📅 Réservations",         "/Views/prestataire/ReservationsView.fxml");
        PRESTATAIRE_NAV.put("💬 Messagerie",           "/Views/prestataire/MessagerieView.fxml");
        PRESTATAIRE_NAV.put("💳 Paiements",            "/Views/prestataire/PaiementsView.fxml");
